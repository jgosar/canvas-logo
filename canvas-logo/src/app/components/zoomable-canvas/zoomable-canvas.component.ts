import type {ElementRef, OnInit, OnChanges, AfterViewChecked} from '@angular/core';
...
import type {RenderingCoordinates} from 'src/app/types/geometry/render-coordinates';
