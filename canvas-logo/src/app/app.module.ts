...
@NgModule({
  ...
  providers: [LogoStore, LogoForwardReducer, RegisterNativeCommandReducer, ExecuteCommandReducer, LogoRightReducer, RegisterLogoCommandReducer, LogoRepeatReducer, LogoPenUpReducer, LogoPenDownReducer],
